package br.com.jwar.groups.data.repositories
...
internal class DefaultGroupRepositoryTest {
    ...
    fun `joinGroup should call groupsDataSource`() = runTest {
        val groupId = "1"
        val invitedUser = User("invited_user_id", "Invited User")
        val joinedUser = User("joined_user_id", "Joined User")
        prepareScenario()

        defaultGroupRepository.joinGroup(groupId, invitedUser, joinedUser)

        coVerify { groupsDataSource.joinGroup(groupId, invitedUser, joinedUser) }
    }
