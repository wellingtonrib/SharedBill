...
class GroupListViewModelTest {
    ...
    @Test
    fun `onInit with error should set error state`() {

    }

    @Test
    fun `onCreateGroup with success should send NavigateToGroupEdit effect`() {

    }

    @Test
    fun `onCreateGroup with error should set error state`() {

    }

    @Test
    fun `onJoinGroup with success should send NavigateToGroupDetails effect`() {

    }

    @Test
    fun `onJoinGroup with error should set error state`() {

    }

    @Test
    fun `onDeleteGroup with success should update loaded state removing the group`() {

    }

    @Test
    fun `onDeleteGroup with error should send ShowError effect`() {

    }

    @Test
    fun `onLeaveGroup with success should update loaded state removing the group`() {

    }

    @Test
    fun `onLeaveGroup with error should send ShowError effect`() {
