...
import br.com.jwar.sharedbill.groups.domain.usecases.GetGroupByIdStreamUseCaseImpl
...
class GetGroupByIdStreamUseCaseImplTest {
    ...
    private val getGroupByIdStreamUseCase = GetGroupByIdStreamUseCaseImpl(groupRepository)
